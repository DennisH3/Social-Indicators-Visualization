...
employGen$`Generation Status` <- as.character(employGen$`Generation Status`)
employGen$`Total Visible Minority` <- as.factor(employGen$`Total Visible Minority`)
...
degIncome <- inner_join(degree, employGen)
