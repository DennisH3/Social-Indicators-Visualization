    ...
    tabPanel("Intersectionality Analyses", fluid = TRUE,
             sidebarLayout(
               ...
               sidebarPanel(
                 ...
                 selectizeInput("VM",
                                label = "Designated Visible Minority Group for Immigrant Status",
                 ...
                 selectizeInput("VM2",
                                label = "Designated Visible Minority Group for Generation Status",
    ...
    tabPanel("Similarity and Differences", fluid = TRUE,
             sidebarLayout(
               sidebarPanel(
                 ...
                 selectizeInput("VisM",
                                label = "Designated Visible Minority Group for Scatter plot",
                 ...
                 selectizeInput("VisMi",
                                label = "Designated Visible Minority Group for Line Graph",
             ...
             mainPanel(
               ...
               h2("Note: The graphs produced in this tab use Synthetic Data"),
             ...
             sidebarLayout(
               sidebarPanel(
                 ...
                 selectizeInput("VisiM",
                                label = "Designated Visible Minority Group",
               ...
               mainPanel(
                 ...
                 h2("Note: The graph produced in this tab uses Synthetic Data"),
                 h4("To filter the data, please select Designated Visible Minority Group, Generation Status, Age, and Sex first.
...
server <- function(input, output) {
  ...
  output$sBar <- renderPlotly({
    ...
    fig <- plot_ly(filtered_sex(), x = ~`Visible Minority Groups`, y = ~Female, type = 'bar', name = "Female",
      ...
      layout(title = "Population of Designated Visible Minority Groups by Education and Field of Study, 2016",
  ...
  output$ecplot <- renderPlotly({
    ...
    fig <- plot_ly(filtered_data(), x = ~`Visible Minority Groups`, y = ~Immigrants, type = 'bar', name = "Immigrants") %>%
      ...
      layout(title = "Population of Designated Visible Minority Groups by Education, Field of Study and Immigrant Status, 2016",
             yaxis = list(title = 'Number of People'), barmode = 'group')
  ...
  output$ecplot2 <- renderPlotly({
    ...
    fig <- plot_ly(filtered_data2(), x = ~`Visible Minority Groups`, y = ~`Third generation or more`,
      ...
      layout(title = "Population of Designated Visible Minority Groups by Education, Field of Study and Generation Status, 2016",
             yaxis = list(title = 'Number of People'), barmode = 'group')
  ...
  output$lgraph <- renderPlotly({
    ...
    lp <- lp %>%
      layout(title = "Average Income for Designated Visible Minority Groups by Census Years",
             hovermode = "x unified",
  ...
  output$map <- renderLeaflet({
    ...
    hoverText <- sprintf(
      "<strong>Designated Visible Minority Group: %s</strong>
  ...
  output$fed <- renderLeaflet({
    ...
    map <- leaflet(CAN) %>%
      ...
      addLegend(pal = pal, values = ~CAN@data[[input$fillBy]], opacity = 0.7,
                title = input$fillBy, position = "topright")
